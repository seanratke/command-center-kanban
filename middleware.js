...
export const config = { matcher: '/((?!api/login|api/run-opportunity-engine|api/inventor-pool|api/resurrection-check|api/synthesis|api/inbox-review-cron|login.html|_next|favicon.ico).*)' };
